...
export default {
    ...
    methods: {
        ...
        processData() {
            this.groupData = this.areaArr.reduce((acc, element) => {
            ...
            // console.log(this.groupData); // 用來監控數據，拿掉無妨

            for (let countyName in this.groupData) {
                this.avgAirData[countyName] = {};
                let sumAQI = 0;
                let countAQI = 0;
                let sumPm10 = 0;
                let countPm10 = 0;
                ...
                for (let dateKey in this.groupData[countyName]) {
                    for (let countyData of this.groupData[countyName][dateKey]) {
        ...
        updateAirData(countyName, selectedTime) {
            if (countyName && this.avgAirData[countyName]) {
                this.currentAirData = this.avgAirData[countyName][selectedTime];
                this.updateAirStatus();

                // console.log(avgAirData);
            }
        },
        // 刷新狀蓋
        updateAirStatus() {
            if (this.currentAirData) {
                if (this.currentAirData.avgAQI <= 50) {
                    this.airStatus = "良好"; //nice
                } else if (this.currentAirData.avgAQI > 50 && this.currentAirData.avgAQI <= 100) {
                    this.airStatus = "普通"; //normal
                } else if (this.currentAirData.avgAQI > 100 && this.currentAirData.avgAQI <= 150) {
                    this.airStatus = "橘警"; //orange
                } else {
                    this.airStatus = "紅害"; //red
                }
            } else {
                this.airStatus = "設備異常"; //error
            }
            // console.log(this.avgAirData);
        },
    ...
    mounted() {
        fetch("https://data.moenv.gov.tw/api/v2/aqx_p_488?api_key=58f5fc65-e6f6-4c1e-a2e1-2a5a69fbaef8")
            .then(res => res.json())
            .then(data => {
...
<template>
    ...
    <div class="svgTaiwan">
        <svg id="cf503461-00bd-459a-aeb5-062ebc913211" data-name="點地圖!!!" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 595.28 841.89" :data-name="county" @click="clickArea">
            <defs />
            <title>
                taiwan.svg
            </title>
        ...
        <path id="28bff46b-f2eb-45d7-8426-8f17aad842d2" data-name="path2468" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M92.75,406.85l1.58-.24L94,407.83l-1.22-1Z"/> -->
            <g id="idPenghu" data-name="Penghu_county" class="penghu">
                ...
                <path id="0c879d5f-d1b8-44ab-8054-414fa434ecd5" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="ac637e03-3275-4541-a525-7037e69241b0" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="3bb77815-2bc3-4801-b8fc-d6e3a2443162" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="8f150979-52b7-46a0-a2fa-4fefa7e27d3a" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="3a11933f-2e32-4079-bca8-5259168f23fa" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <path id="b0b2ccdd-fcdf-4a6f-9b32-6959a098936a" data-name="澎湖縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="2b6aac2d-ce2d-4c48-89d5-ff2a81000e07" data-name="嘉義縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="30e45b59-571b-4340-a006-0ba62460619a" data-name="臺中市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="21535635-db1e-4831-a63f-263ab3ed4b79" data-name="基隆市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="21c4ba33-d057-42c1-9c71-be6061fc73cf" data-name="屏東縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="1e48e0bb-8964-4121-b347-b900162cf771" data-name="臺北市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="66958373-17e2-4fab-8b83-b16e2d323782" data-name="新北市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="f8107e5f-0c12-4631-aed9-d525f4e8558d" data-name="宜蘭縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="65175d47-0a21-4bf1-abfb-b58e4d3069a0" data-name="桃園市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="350fa9bc-d25e-4c61-ae4b-b5c60b1a74b6" data-name="新竹市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="ea41be52-3728-49f2-aa36-b90633ee55f6" data-name="新竹縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="ffd01e75-6ce2-4cfa-af98-bc61479c68ed" data-name="苗栗縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="d5701392-fc06-4411-bf79-2703f225ab2e" data-name="彰化縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="4eed8214-870d-46ff-b77b-49234479d430" data-name="雲林縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="e468a7aa-2bdf-4501-b48d-35483b7c8ccc" data-name="花蓮縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="7ed22330-8901-4fc6-a351-206f6b2daf2b" data-name="南投縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="ae9239f1-7686-4c40-a5f8-f322391c7328" data-name="臺東縣" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="0ce2847a-4f9c-4ff7-8c51-6b0fa24ba8b7" data-name="臺南市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="e1806d87-d003-48dd-b8d3-3f99b3759340" data-name="高雄市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <path id="ae28d47a-650c-43d9-aedc-c1d11a068993" data-name="嘉義市" class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
            ...
            <g id="f292dbb8-1f08-451f-af4d-83b2a6953aa2" data-name="kinmen_country" class="kinmen">
                <path id="b83ee7c9-49c5-43e6-acea-f06d1c113084" data-name="金門縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 kinmen"
                ...
                <path id="095a4c54-e8f5-4120-91cf-b6c705de29ff" data-name="金門縣"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 kinmen"
                ...
                <path id="87972721-81c8-4058-acb3-6963aa0ed3e0" data-name="path2655"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 kinmen" d="M107.46,220l-.75.25.31.31H108l-.5-.56h0Z" />
                <path id="1618ff3b-8feb-42b3-b000-0d7dc2b4b993" data-name="path2657"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9 kinmen" d="M111.85,244l-.38.38.88-.06-.5-.31Z" />
            </g>
            ...
            <g id="13520621-f1ed-4c7b-8b5d-1a169d9bf935" data-name="g4313" class="lienchiang">
                ...
                <path id="cbfdad05-a89f-40ed-902b-cdd90c10f2fe" data-name="連江縣"
                ...
                <path id="167388a5-547c-4480-932a-6c0a66e1048a" data-name="連江縣"
                    class="bc4bd339-f614-4405-a1f2-7f894051d5a3"
    ...
    <div class="showArea">
        <div class="info">
            ...
            <div class="selectInfo">
                <select v-model="selectedTime" @change="updateAirData">
            ...
            <div class="dataInfo">
                ...
                <div class="rightInfo">
                    <span>AQI: </span>
                    <span id="apiValue" v-if="currentAirData && currentAirData.avgAQI !== null">{{ currentAirData.avgAQI
                        }}</span>
                    <br>
                    <!-- <p id="airSo2">SO<sub>2</sub>:{{ currentAirData.avgSo2 }}</p> -->
                    <span>SO<sub>2</sub>: </span>
                    <span v-if="currentAirData && currentAirData.avgSo2 !== null">
                        {{ currentAirData.avgSo2 }} <sub>小時濃度</sub>
                    </span>
                    <br>
                    <span>PM<sub>10</sub>: </span>
                    <span id="airStatus" v-if="(currentAirData && currentAirData.avgPm10 !== null)">
                        {{ currentAirData.avgPm10 }} <sub>小時濃度</sub>
                    </span>

                    <!-- <span id="airStatus" v-else-if="currentAirData.avgPm10 == NaN">設備異常</span> -->

                </div>

                <div class="leftInfo">
                    <!-- <p id="airO3">O<sub>3</sub>:{{ currentAirData.avgO3 }}</p> -->
                    <span>O<sub>3</sub>: </span>
                    <span v-if="currentAirData && currentAirData.avgO3 !== null">
                        {{ currentAirData.avgO3 }} <sub>小時濃度</sub>
                    </span>
                    <br>

                    <span>CO: </span>
                    <span v-if="currentAirData && currentAirData.Co !== null">
                        {{ currentAirData.avgCo }} <sub>小時濃度</sub>
                    </span>
                    <br>
                    <!-- <p id="airSo2">SO<sub>2</sub>:{{ currentAirData.avgSo2 }}</p> -->
                    <span>NO<sub>2</sub>: </span>
                    <span v-if="currentAirData && currentAirData.avgNo2 !== null">
                        {{ currentAirData.avgNo2 }} <sub>小時濃度</sub>
                    </span>
                </div>
            </div>
            ...
            <div class="noteInfo">
                <span>NaN為設備異常，</span>
                <a href="https://data.moenv.gov.tw/announcement">請見</a>
            </div>
...
.showArea {
    ...
    .info {
        ...
        .nice {
            border: 5px solid rgb(47, 177, 75);
        }

        .normal {
            border: 5px solid rgb(243, 240, 41);
        }

        .orange {
            border: 5px solid rgb(243, 161, 46);
        }

        .red {
            border: 5px solid rgb(227, 36, 36);
        }
