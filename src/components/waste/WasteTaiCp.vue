...
//資料集
const arrYear = ref([])
const wasteCityOut = ref([])
const wasteCityHandle = ref([])
const wasteAllOut = ref([])
const wasteAllHandle = ref([])
onMounted(() => {
        ...
        DataCity_out.value.forEach((item) => {
            ...
            if ((Number(day[0].split("年")[0]) >= 110) && (Number(day[0].split("年")[0]) <= 112)) {
                if (Object.keys(day).length == 2){
                    CityOut.統計期_年 = day[0].split("年")[0];
                    CityOut.統計期_月 = day[1].split("月")[0];
                    CityOut.統計區 = item.item2;
                    CityOut.總產生量 = item.value1;
                    CityOut.一般垃圾量 = item.value2;
                    CityOut.資源垃圾量 = item.value3;
                    CityOut.廚餘量 = item.value4;
                    wasteCityOut.value.push(CityOut);
                }
            ...
            wasteCityOut.value.forEach((item) => {
    ...
    .then(dataCity_handle =>{
        ...
        DataCity_handle.value.forEach((item) => {
            ...
            if ((Number(day[0].split("年")[0]) >= 110) && (Number(day[0].split("年")[0]) <= 112)) {
                if (Object.keys(day).length == 2){
                    CityHandle.統計期_年 = day[0].split("年")[0];
                    CityHandle.統計期_月 = day[1].split("月")[0];
                    CityHandle.統計區 = item.item2;
                    CityHandle.總處理量 = item.value1;
                    CityHandle.回收再利用量 = item.value2;
                    CityHandle.焚化量 = item.value3;
                    CityHandle.衛生掩埋量 = item.value4;
                    CityHandle.其他處理量 = item.value5;
                    wasteCityHandle.value.push(CityHandle);
                }
                if (Object.keys(day).length == 1){
                    CityHandle.統計期_年 = day[0].split("年")[0];
                    CityHandle.統計區 = item.item2;
    ...
    .then(dataAll_out =>{
        ...
        DataAll_out.value.forEach((item) => {
            ...
            let day = item.item1.split(" ")
            if (Object.keys(day).length == 2){
                AllOut.統計期_年 = day[0].split("年")[0];
                AllOut.統計期_月 = day[1].split("月")[0];
                AllOut.總產生量 = item.value1;
                AllOut.一般垃圾量 = item.value2;
                AllOut.資源垃圾量 = item.value3;
                AllOut.廚餘量 = item.value4;
                wasteAllOut.value.push(AllOut);
            }
            if (Object.keys(day).length == 1){
                AllOut.統計期_年 = day[0].split("年")[0];
                AllOut.總產生量 = item.value1;
    ...
    .then(dataAll_handle =>{
        ...
        DataAll_handle.value.forEach((item) => {
            ...
            let day = item.item1.split(" ")
            if (Object.keys(day).length == 2){
                AllHandle.統計期_年 = day[0].split("年")[0];
                AllHandle.統計期_月 = day[1].split("月")[0];
                AllHandle.總處理量 = item.value1;
                AllHandle.回收再利用量 = item.value2;
                AllHandle.焚化量 = item.value3;
                AllHandle.衛生掩埋量 = item.value4;
                AllHandle.其他處理量 = item.value5;
                wasteAllHandle.value.push(AllHandle);
            }
            if (Object.keys(day).length == 1){
                AllHandle.統計期_年 = day[0].split("年")[0];
                AllHandle.總處理量 = item.value1;
